 ...
 */
@ManagedBean
public class chartsbarDeparte2 {
    ...
    private BarChartModel initBarModel() throws Exception{
        ...
        intervenant.set("QUALITE TD", this.countQualiterTeam());
        intervenant.set("QUALITE IM",this.countQualiterInspection());
      ; intervenant.set("LOGISTIQUE MR",this.countLogistiqueMagasinRe());
        intervenant.set("LOGISTIQUE MS", this.countLogistiqueSupermaché());
        intervenant.set("LOGISTIQUE EXP1",this.countLogistiqueExpedition1());
        intervenant.set("LOGISTIQUE EXP2", this.countLogistiqueExpedition2());
