...
@ManagedBean
@SessionScoped
public class SendAllIntervenant {
	...
	public  void send(String user) throws Exception {
		...
		try {
			...
			message.setSubject("nouvelle Reclamation creer");
			message.setText("nouvelle Reclamation creer par intervenant : '"+user +"'");
...
//    
//    for(int i=0;i<inter.getMails().size();i++){
//        this.send(inter.getMails().get(i).getEmail());
//    }
//}
