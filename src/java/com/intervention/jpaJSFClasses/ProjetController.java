...
import com.intervention.jpa.sessionBean.ProjetFacade;
...
public class ProjetController implements Serializable {
    ...
    @EJB
    private com.intervention.jpa.sessionBean.ProjetFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Resources/Bundle").getString("ProjetCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Resources/Bundle").getString("ProjetUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Resources/Bundle").getString("ProjetDeleted"));
        if (!JsfUtil.isValidationFailed()) {
