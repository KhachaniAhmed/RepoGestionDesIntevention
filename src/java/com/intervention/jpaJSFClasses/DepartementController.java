...
import com.intervention.jpa.sessionBean.DepartementFacade;
...
public class DepartementController implements Serializable {
    ...
    @EJB
    private com.intervention.jpa.sessionBean.DepartementFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Resources/Bundle").getString("DepartementCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Resources/Bundle").getString("DepartementUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Resources/Bundle").getString("DepartementDeleted"));
        if (!JsfUtil.isValidationFailed()) {
