...
import com.intervention.jpa.sessionBean.IntervenantFacade;
...
public class IntervenantController implements Serializable {
    ...
    @EJB
    private com.intervention.jpa.sessionBean.IntervenantFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Resources/Bundle").getString("IntervenantCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Resources/Bundle").getString("IntervenantUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Resources/Bundle").getString("IntervenantDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Intervenant getIntervenant(java.lang.Integer id) {
    ...
    public static class IntervenantControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Intervenant) {
                ...
                return getStringKey(o.getMatriculeintervenant());
            } else {
