...
import com.intervention.jpa.sessionBean.PanneFacade;
...
public class PanneController implements Serializable {
    ...
    @EJB
    private com.intervention.jpa.sessionBean.PanneFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Resources/Bundle").getString("PanneCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Resources/Bundle").getString("PanneUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Resources/Bundle").getString("PanneDeleted"));
        if (!JsfUtil.isValidationFailed()) {
