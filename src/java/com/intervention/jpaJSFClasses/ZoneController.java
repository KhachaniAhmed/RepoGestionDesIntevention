...
public class ZoneController implements Serializable {
    ...
    @EJB
    private com.intervention.jpa.sessionBean.ZoneFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Resources/Bundle").getString("ZoneCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Resources/Bundle").getString("ZoneUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Resources/Bundle").getString("ZoneDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class ZoneControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Zone) {
                Zone o = (Zone) object;
                return getStringKey(o.getIdZone());
            } else {
