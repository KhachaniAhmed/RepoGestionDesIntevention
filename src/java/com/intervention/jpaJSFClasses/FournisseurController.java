...
import com.intervention.jpa.sessionBean.FournisseurFacade;
...
public class FournisseurController implements Serializable {
    ...
    @EJB
    private com.intervention.jpa.sessionBean.FournisseurFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Resources/Bundle").getString("FournisseurCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Resources/Bundle").getString("FournisseurUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Resources/Bundle").getString("FournisseurDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class FournisseurControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Fournisseur) {
                ...
                return getStringKey(o.getNumeroFournisseur());
            } else {
